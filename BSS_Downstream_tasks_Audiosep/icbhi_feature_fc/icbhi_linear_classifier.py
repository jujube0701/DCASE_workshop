...
FEATURES_PATH = 'icbhi_feature_fc/icbhi_features_audiosep.pt'
...
labels = features_labels['labels'].view(-1)  # 保證 shape 為 [N]
...
class ThreeLayerClassifier(nn.Module):
    def __init__(self, in_dim=384, num_classes=2, hidden_dim=256):
        super().__init__()
